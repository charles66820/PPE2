    ...
    if (!isset($_GET['id'])) {
      ...
      if (isset($_POST['addproduitpanier']) && !empty($_POST['addproduitpanier']) && isset($_POST['quentiterproduit']) && !empty($_POST['quentiterproduit'])) {
        if (!ajouterArticle(intval(htmlspecialchars($_POST['addproduitpanier'])), intval(htmlspecialchars($_POST['quentiterproduit'])))) {
          ...
          echo '<script> document.location.replace("/catalogue.php"); </script>';
        }
      }
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <div class="m-2" id="listimgproduit">
                ...
                $reqphotoproduit->execute(array($produitid));
              ...
              <div class="col-md-4">
                ...
                $reqproduit->execute(array($produitid));
                ...
                $reqpmoyenne->execute(array($produitid));
                ...
                <div>
                  ...
                  <div>
                    <select class="float-right" name="quentiterproduit" style="height:26px;margin-top:-34px;margin-right:24px;">
                ...
                <div><button class="btn btn-primary" name="addproduitpanier" value="<?php echo $produitid; ?>" type="submit" data-bs-hover-animate="tada" style="max-width:295px;max-height:80px;margin-top:18px;font-size:31px;">Ajouter au panier&nbsp;</button></div>
              </form>
            </div>
          </div>
      ...
      <div class="container" style="margin-bottom:60px;">
        ...
        $selectcomment->execute(array($produitid));
